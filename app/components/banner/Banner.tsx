...
const BannerCarousel: React.FC = () => {
  ...
  const bannerSlides: BannerSlide[] = [
    ...
    },
    {
      ...
      description: "Nestled among the rolling hills, Mountain Haven offers panoramic views of lush green valleys and mist-covered peaks. Experience the tranquility of nature while enjoying modern comforts in our eco-friendly accommodations.",
    ...
    },
    {
      ...
      description: "Immerse yourself in the heart of ancient forests, where time slows down and every breath connects you deeper with nature. Our sustainable cottages blend seamlessly with the surroundings, offering a truly authentic wilderness experience.",
      imageUrl: "/banner/Drifters_Valley.png",
    },
    {
      id: 4,
      ...
      description: "Let the gentle sounds of flowing water soothe your soul at our riverside sanctuary. Wake up to birdsong and spend your days exploring nearby waterfalls, wildlife, and the rich biodiversity of the Western Ghats.",
      imageUrl: "/banner/VayaloramRetreat.png",
    },
    {
      id: 5,
      ...
      description: "Surrounded by endless waves of emerald tea plantations, this exclusive retreat offers a glimpse into Kerala's rich agricultural heritage while providing a peaceful sanctuary for relaxation and rejuvenation.",
      imageUrl: "/banner/Drifters_Valley.png",
    }
  ];
    ...
    <div className="relative w-[95%] h-[75vh]  md:h-screen max-w-full mx-auto my-3 overflow-hidden rounded-2xl">
        ...
        {bannerSlides.map((_, index) => (
          <button
            ...
            className={`h-1 sm:h-1.5 md:h-2 rounded-full transition-all ${
              currentSlide === index ? 'w-3 sm:w-4 md:w-6 bg-white' : 'w-1 sm:w-1.5 md:w-2 bg-white/50'
            }`}
      ...
      <div className="absolute bottom-2 sm:bottom-4 md:bottom-6 w-full md:w-auto md:right-6 lg:right-16 z-30">
        <div className="text-center md:text-right mb-1 sm:mb-2">
          <h3 className="text-xs sm:text-sm md:text-lg lg:text-xl text-white font-medium">Explore the Unexplored</h3>
        </div>
        <div className="flex items-center justify-center md:justify-end space-x-6 sm:space-x-8 md:space-x-8">
          <div className="flex flex-col items-center">
            <div className="bg-white/10 backdrop-blur-sm rounded-full p-1.5 sm:p-2 md:p-3 mb-0.5 sm:mb-1 md:mb-2">
              <img src="/bannerbottomrightlogo/Untouchedtrails.png" alt="Untouched trails" className="h-4 w-4 sm:h-5 sm:w-5 md:h-6 md:w-6" />
            </div>
            <span className="text-xxs xs:text-tiny sm:text-xs text-center text-white leading-tight">Untouched<br />trails</span>
          </div>

          <div className="flex flex-col items-center">
            <div className="bg-white/10 backdrop-blur-sm rounded-full p-1.5 sm:p-2 md:p-3 mb-0.5 sm:mb-1 md:mb-2">
              <img src="/bannerbottomrightlogo/Mountainserenity.png" alt="Mountain serenity" className="h-4 w-4 sm:h-5 sm:w-5 md:h-6 md:w-6" />
            </div>
            <span className="text-xxs xs:text-tiny sm:text-xs text-center text-white leading-tight">Mountain<br />serenity</span>
          </div>

          <div className="flex flex-col items-center">
            <div className="bg-white/10 backdrop-blur-sm rounded-full p-1.5 sm:p-2 md:p-3 mb-0.5 sm:mb-1 md:mb-2">
              <img src="/bannerbottomrightlogo/Naturehikes.png" alt="Nature hikes" className="h-4 w-4 sm:h-5 sm:w-5 md:h-6 md:w-6" />
            </div>
            <span className="text-xxs xs:text-tiny sm:text-xs text-center text-white leading-tight">Nature<br />hikes</span>
          </div>
        </div>
      </div>
    </div>
