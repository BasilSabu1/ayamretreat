...
const Testimonials = () => {
  const testimonials: Testimonial[] = [
    ...
    // More testimonials can be added here
    {
      ...
      comment: '"The service has been reliable and secure. Exactly what I needed for my work."',
      rating: 4.5,
      avatar: '/review/review3.png',
    },
  ];
  ...
  const visibleTestimonials = currentIndex === 0 
    ...
    <section className="bg-white py-16 overflow-hidden">
      <div className="max-w-6xl mx-auto px-4 relative">
        ...
        <div className="text-center mb-16 max-w-2xl mx-auto">
          <h2 className="text-2xl md:text-3xl font-semibold text-gray-800 mb-2">Testimonials</h2>
          ...
          {visibleTestimonials.map((testimonial) => (
            ...
            >
              <div className="flex items-center justify-between mb-4">
                ...
                <div className="flex items-center">
                  <span className="mr-2 font-semibold">{testimonial.rating}</span>
