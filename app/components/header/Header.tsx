      ...
      <header className="flex items-center justify-between px-6 py-4 bg-white">
        ...
        <nav className="hidden md:flex items-center ml-auto mr-20">
          <div className="flex space-x-12">
            ...
            <a href="#blog" className="text-gray-800 hover:text-blue-500">Blog</a>
          </div>
        </nav>

        {/* Account button */}
        <div className="flex items-center space-x-4">
          <a href="#account" className="hidden md:flex items-center text-gray-800 hover:text-blue-500">
      ...
      {mobileMenuOpen && (
        <div className="md:hidden bg-white shadow-lg absolute top-16 right-0 left-0 z-10">
          <nav className="flex flex-col px-4 py-2">
            <a href="#about" className="py-2 text-gray-800 hover:text-blue-500">About us</a>
            <a href="#testimonials" className="py-2 text-gray-800 hover:text-blue-500">Testimonials</a>
            <a href="#blog" className="py-2 text-gray-800 hover:text-blue-500">Blog</a>
            <a href="#account" className="py-2 text-gray-800 hover:text-blue-500 flex items-center">
              <svg viewBox="0 0 24 24" width="20" height="20" stroke="currentColor" fill="none" className="mr-2">
                <circle cx="12" cy="8" r="5" strokeWidth="2" />
                <path d="M3 21v-2a9 9 0 0 1 18 0v2" strokeWidth="2" />
              </svg>
